...
at::Tensor ApproxMatchForward(
  ...
  AT_DISPATCH_FLOATING_TYPES(xyz1.type(), "ApproxMatchForward", ([&] {
...
at::Tensor MatchCostForward(
  ...
  AT_DISPATCH_FLOATING_TYPES(xyz1.type(), "MatchCostForward", ([&] {
...
std::vector<at::Tensor> MatchCostBackward(
  ...
  AT_DISPATCH_FLOATING_TYPES(xyz1.type(), "MatchCostBackward", ([&] {
