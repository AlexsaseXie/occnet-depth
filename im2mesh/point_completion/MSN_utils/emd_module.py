...
class emdFunction(Function):
    ...
    def forward(ctx, xyz1, xyz2, eps, iters):
        ...
        _ext.emd_forward(xyz1, xyz2, dist, assignment, price, assignment_inv, bid, bid_increments, max_increments, unass_idx, unass_cnt, unass_cnt_sum, cnt_tmp, max_idx, eps, iters)
    ...
    def backward(ctx, graddist, gradidx):
        ...
        _ext.emd_backward(xyz1, xyz2, gradxyz1, graddist, assignment)
