...
class expansionPenaltyFunction(Function):
    ...
    def forward(ctx, xyz, primitive_size, alpha):
        ...
        _ext.expansion_penalty_forward(xyz, primitive_size, assignment, dist, alpha, neighbor, cost, mean_mst_length)
    ...
    def backward(ctx, grad_dist, grad_idx, grad_mml):
        ...
        _ext.expansion_penalty_backward(xyz, grad_xyz, grad_dist, assignment)
