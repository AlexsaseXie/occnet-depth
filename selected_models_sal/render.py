...
SELECTED_MODEL_ROOT = '/home2/xieyunwei/occupancy_networks/selected_models_sal/selected_models_sal/'
TEST_RENDERING_PATH = '/home2/xieyunwei/occupancy_networks/selected_models_sal/render_test'
...
FILE_NAMES = ['gt.off', 'sal.off', 'sail_s3.off', 'spsr.ply']
...
def test():
    ...
    class_id = '02691156'
    model_id = ['d78a16856adad344670aaa01f77ae41a']
    file_paths = []
