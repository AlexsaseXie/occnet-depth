...
TEST_RENDERING_PATH = '/home2/xieyunwei/occupancy_networks/selected_models/render_test'
...
FILE_NAMES = ['atlasnet.ply', 'disn.obj', 'gt.off', 'imnet.ply', 'onet.off', 'ours.off', 'pix2mesh.off']
