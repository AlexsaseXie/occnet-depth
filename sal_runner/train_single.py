...
for batch in train_loader:
    ...
    scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[100000, 150000], gamma=0.1)
    if trainer.z_optimizer is not None:
        z_scheduler = optim.lr_scheduler.MultiStepLR(trainer.z_optimizer, milestones=[100000, 150000], gamma=0.1)
    else:
        z_scheduler = None
